...
export default function ParentForgotPinVerifyLight() {
  ...
  return (
    ...
    >
      ...
      <div style={{
        ...
        <motion.button
          onClick={() => navigate('/parent-forgot-pin-light')}
          whileTap={{ scale: 0.93 }}
          style={{
        ...
        <motion.div {...fadeUp(0.1)} style={{ display: 'flex', flexDirection: 'column', gap: 8, marginBottom: 32 }}>
          ...
          <span style={{ fontFamily: 'Inter', fontSize: 14, color: '#737373', lineHeight: 1.6, textAlign: 'center' }}>
            ...
            <span style={{ color: '#1A1A2E', fontWeight: 500 }}>+225 07 07 07 07</span>
            . Valable 10 minutes.
          </span>
        </motion.div>
            ...
            return (
              <input
                ...
                style={{
                  ...
                  border: `1.5px solid ${isFocused ? '#4F46E5' : d ? '#4F46E5' : '#DDDDE8'}`,
                  outline: 'none',
        ...
        <motion.div {...fadeUp(0.2)} style={{
          ...
          <span style={{ fontFamily: 'Inter', fontSize: 13, color: '#737373' }}>
            Le code expire dans{' '}
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
          <motion.button
            onClick={() => allFilled && navigate('/parent-new-pin-light')}
            {...fadeUp(0.25)}
            whileTap={allFilled ? { scale: 0.98 } : {}}
            style={{
              height: 56, borderRadius: 16,
              backgroundColor: allFilled ? '#4F46E5' : '#E8E8F4', border: 'none',
              cursor: allFilled ? 'pointer' : 'default',
              fontFamily: 'Inter', fontSize: 15, fontWeight: 600,
              color: allFilled ? '#FFFFFF' : '#A0A0C0',
              width: '100%',
