...
export default function LangueSelection() {
    ...
    >
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 6 }}>
          <span style={{ fontFamily: 'Rethink Sans', fontSize: 24, fontWeight: 800, color: '#FFFFFF' }}>
            ...
            >
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: 14 }}>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: 2, textAlign: 'left' }}>
                  <span style={{ fontFamily: 'Inter', fontSize: 15, fontWeight: selected === lang.id ? 600 : 400, color: '#FFFFFF' }}>
                    {lang.name}
                  </span>
