...
export default function ForgotPasswordVerifyLight() {
    ...
    >
      ...
      <div style={{
        ...
        <motion.div {...fadeUp(0.05)} style={{
          ...
          <Inbox size={26} color="#4F46E5" strokeWidth={1.5} />
        </motion.div>

        <motion.div {...fadeUp(0.1)} style={{ display: 'flex', flexDirection: 'column', gap: 8, marginBottom: 32 }}>
          <span style={{ fontFamily: '"Rethink Sans", sans-serif', fontSize: 26, fontWeight: 800, color: '#1A1A2E', textAlign: 'center' }}>
            Vérifiez vos e-mails
          </span>
          <span style={{ fontFamily: 'Inter', fontSize: 14, color: '#737373', lineHeight: 1.6, textAlign: 'center' }}>
            Entrez le code à 6 chiffres envoyé à{' '}
            <span style={{ color: '#1A1A2E', fontWeight: 500 }}>ivan@gmail.com</span>
            . Valable 10 minutes.
          </span>
        </motion.div>
            ...
            return (
              <input
                ...
                style={{
                  ...
                  border: `1.5px solid ${isFocused ? '#4F46E5' : d ? '#BBBBD4' : '#D5D5EA'}`,
                  outline: 'none',
                  fontFamily: '"Rethink Sans", sans-serif',
                  fontSize: 22, fontWeight: 700, textAlign: 'center',
                  color: isFocused ? '#4F46E5' : '#1A1A2E',
                  caretColor: '#4F46E5',
        ...
        <motion.div {...fadeUp(0.2)} style={{
          ...
          <span style={{ fontFamily: 'Inter', fontSize: 13, color: '#AAAABD' }}>
            Le code expire dans{' '}
            <span style={{ color: timer > 10 ? '#1A1A2E' : '#EF4444', fontWeight: 500 }}>
              {formatTime(timer)}
            </span>
          </span>
          <button
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
          <motion.button
            onClick={() => allFilled && navigate('/new-password-light')}
            {...fadeUp(0.25)}
            whileTap={allFilled ? { scale: 0.98 } : {}}
            style={{
              height: 56, borderRadius: 16,
              backgroundColor: allFilled ? '#4F46E5' : '#E5E5F2', border: 'none',
              cursor: allFilled ? 'pointer' : 'default',
              fontFamily: 'Inter', fontSize: 15, fontWeight: 600,
              color: allFilled ? '#FFFFFF' : '#AAAABD',
              width: '100%',
          ...
          <button
            ...
            style={{
              ...
              fontFamily: 'Inter', fontSize: 14, color: '#AAAABD', textAlign: 'center',
            }}
          >
