...
export default function ParentHistoriqueLight() {
  ...
  const filterBg    = filterActive ? '#4F46E5' : '#eaeaf2'
  const filterColor = filterActive ? '#FFFFFF'  : '#1a1a2e'
  ...
  return (
    ...
    >
      ...
      <div style={{
        ...
        >
          <SlidersHorizontal size={17} color={filterColor} strokeWidth={2} />
        </motion.div>
      </div>
      ...
      <div style={{
        ...
        <motion.div {...fadeUp(0)} style={{
          ...
          <Search size={17} color="#555577" strokeWidth={1.75} />
          <input
            type="text"
            value={searchText}
        ...
        <motion.div {...fadeUp(0.05)} style={{
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 4 }}>
            ...
            <span style={{ fontFamily: '"Rethink Sans", sans-serif', fontSize: 24, fontWeight: 800, color: '#1a1a2e' }}>
              EUR 650
            </span>
          </div>
          ...
          >
            <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: 3 }}>
                <span style={{ fontFamily: 'Inter', fontSize: 14, fontWeight: 600, color: '#1a1a2e' }}>{tx.name}</span>
        ...
        {displayed.length === 0 && (
          <div style={{
            ...
            <span style={{ fontFamily: 'Inter', fontSize: 14, color: '#9494B8', textAlign: 'center' }}>
      ...
      <ParentTabBar activeTab="Historique" theme="light" />
