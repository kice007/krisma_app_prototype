...
function SettingIcon({ color = '#0a0a0f', size = 20 }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none">
...
function CopyIcon({ color = '#4F46E5', size = 14 }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none">
...
function GlobalIcon({ color = '#4F46E5', size = 16 }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none">
      <path stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" d="M12 22c5.52 0 10-4.48 10-10S17.52 2 12 2 2 6.48 2 12s4.48 10 10 10Z" />
...
function AppearanceIcon({ color = '#4F46E5', size = 16 }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none">
...
function BellIcon({ color = '#4F46E5', size = 16 }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none">
...
function MessageIcon({ color = '#4F46E5', size = 16 }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none">
  ...
  return (
    ...
    >
      <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
        ...
        <span style={{ fontFamily: 'Inter', fontSize: 15, fontWeight: 400, color: '#0a0a0f' }}>
          {label}
        </span>
      </div>
...
export default function ProfilDocumentsAltLight() {
  ...
  return (
    ...
    >
      ...
      <div style={{
        ...
        <span style={{ fontFamily: 'Rethink Sans', fontSize: 20, fontWeight: 700, color: '#0a0a0f' }}>
          Mon profil
        </span>
        <button style={{
          width: 40, height: 40, borderRadius: 50,
          ...
          <SettingIcon color="#0a0a0f" size={20} />
        </button>
      </div>
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 16 }}>
            <div style={{
              ...
              <span style={{ fontFamily: 'Rethink Sans', fontSize: 22, fontWeight: 800, color: '#0a0a0f' }}>IE</span>
            </div>
            <div style={{ display: 'flex', flexDirection: 'column', gap: 5 }}>
              <span style={{ fontFamily: 'Rethink Sans', fontSize: 19, fontWeight: 700, color: '#0a0a0f' }}>
                Ivan Ehouman
              </span>
              <div style={{ display: 'flex', alignItems: 'center', gap: 6 }}>
              ...
              <span style={{ fontFamily: 'Inter', fontSize: 12, fontWeight: 600, color: '#4F46E5' }}>
                Étudiant · Krisma
              </span>
            </div>
          </div>
          ...
          <div style={{
            ...
            <div style={{ flex: 1, display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 4 }}>
              <span style={{ fontFamily: 'Inter', fontSize: 15, fontWeight: 600, color: '#0a0a0f' }}>Oct. 2023</span>
              <span style={{ fontFamily: 'Inter', fontSize: 11, fontWeight: 400, color: '#8080A0' }}>Membre depuis</span>
            </div>
            <div style={{ width: 1, height: 32, backgroundColor: '#e5e5f0', flexShrink: 0 }} />
            <div style={{ flex: 1, display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 4 }}>
              <span style={{ fontFamily: 'Inter', fontSize: 15, fontWeight: 600, color: '#0a0a0f' }}>FR76 ****</span>
              <span style={{ fontFamily: 'Inter', fontSize: 11, fontWeight: 400, color: '#8080A0' }}>Mon IBAN</span>
            </div>
            <div style={{ width: 1, height: 32, backgroundColor: '#e5e5f0', flexShrink: 0 }} />
            <div style={{ flex: 1, display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 4 }}>
              <span style={{ fontFamily: 'Inter', fontSize: 15, fontWeight: 600, color: '#0a0a0f' }}>Standard</span>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
            ...
            <div style={{
              ...
              border: '1px solid #e5e5f0', padding: 12,
              ...
              <div style={{
                ...
                <BookIcon color="#4F46E5" size={20} />
              </div>
              <div style={{ flex: 1, display: 'flex', flexDirection: 'column', gap: 3 }}>
                <span style={{ fontFamily: 'Inter', fontSize: 15, fontWeight: 600, color: '#0a0a0f' }}>Passeport</span>
            ...
            <div style={{
              ...
              <div style={{
                ...
                <DocTextIcon color="#4F46E5" size={20} />
              </div>
              <div style={{ flex: 1, display: 'flex', flexDirection: 'column', gap: 3 }}>
                <span style={{ fontFamily: 'Inter', fontSize: 15, fontWeight: 600, color: '#0a0a0f' }}>Titre de séjour</span>
            ...
            <div style={{
              ...
              <div style={{
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
                  <div style={{
                    ...
                    <GiftIcon color="#4F46E5" size={20} />
                  </div>
                  <div style={{ display: 'flex', flexDirection: 'column', gap: 2 }}>
                    <span style={{ fontFamily: 'Inter', fontSize: 14, fontWeight: 600, color: '#0a0a0f' }}>Invitez vos parents</span>
              ...
              <div style={{
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: 3 }}>
                  ...
                  <span style={{ fontFamily: 'Inter', fontSize: 17, fontWeight: 700, color: '#0a0a0f', letterSpacing: 1.5 }}>KRISMA-IE24</span>
                </div>
                <button
                  onClick={handleCopy}
                  style={{
                ...
                >
                  <CopyIcon color="#4F46E5" size={14} />
                  <span style={{ fontFamily: 'Inter', fontSize: 12, fontWeight: 600, color: '#4F46E5' }}>Copier</span>
                </button>
              </div>
            </div>
          </div>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
            ...
            <div style={{
              ...
              <div style={{ height: 1, backgroundColor: '#e5e5f0' }} />
              <SettRow icon={<MessageIcon color="#4F46E5" size={20} />} label="Support chat 24h" value="WhatsApp" />
              <div style={{ height: 1, backgroundColor: '#e5e5f0' }} />
      ...
      <TabBar activeTab="Profil" theme="light" />
