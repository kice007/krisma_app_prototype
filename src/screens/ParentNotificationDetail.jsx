...
const ROWS = [
  { label: 'Bénéficiaire', value: 'Ivan Ehouman', valueColor: '#FFFFFF' },
  { label: 'Montant', value: 'EUR 300', valueColor: '#FFFFFF' },
  { label: 'Équivalent', value: '196 500 FCFA', valueColor: '#FFFFFF' },
  { label: 'Méthode', value: 'Orange Money', valueColor: '#FFFFFF' },
      ...
      <div style={{ flex: 1, overflowY: 'auto', position: 'relative', top: 124 }}>
        <div style={{
          ...
          <span style={{
            ...
            color: '#FFFFFF', textAlign: 'center', marginTop: -4,
          }}>
            - EUR 300
          </span>
          ...
          <div style={{
            ...
            {ROWS.map(({ label, value, valueColor }, i) => (
              <div key={label} style={{
                ...
                padding: '12px 0',
                borderTop: i === 0 ? 'none' : '0.5px solid #2A2A4A',
              }}>
