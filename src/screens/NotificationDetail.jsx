...
const ROWS = [
  { label: 'Expéditeur', value: 'Papa', valueColor: '#FFFFFF' },
  { label: 'Taux de change', value: '1 EUR = 655 FCFA', valueColor: '#FFFFFF' },
  { label: 'Montant en FCFA', value: '≈ 196 500 FCFA', valueColor: '#22C55E' },
  { label: 'Date', value: "Aujourd'hui · 09:34", valueColor: '#FFFFFF' },
  ...
  return (
    ...
    >
      ...
      <div style={{
        ...
        {/* Sub-label */}
        <span style={{ fontFamily: 'Inter', fontSize: 14, color: '#A3A3A3' }}>
          Reçu de Papa
        </span>
        ...
        {/* Status badge */}
        <div style={{
          borderRadius: 10, backgroundColor: 'rgba(34,197,94,0.12)',
        ...
        <div style={{
          ...
          backgroundColor: '#0D1025', border: '0.5px solid #1E1E2E',
          ...
          {ROWS.map(({ label, value, valueColor }) => (
            <div key={label} style={{
              ...
              <span style={{ fontFamily: 'Inter', fontSize: 13, color: '#555577' }}>{label}</span>
        ...
        >
          <span style={{ fontFamily: 'Inter', fontSize: 14, color: '#818CF8' }}>Voir mon solde</span>
        </button>
      </div>
    </motion.div >
  )
