...
export default function DemandeMontantLight() {
  ...
  return (
    ...
    >
      <style>{`
        @keyframes dmlBlink { 0%,49%{opacity:1} 50%,100%{opacity:0} }
        .dml-cursor { animation: dmlBlink 1s step-end infinite; user-select:none; }
        .dml-note::placeholder { color: #737373; }
      `}</style>
      ...
      <div style={{
        ...
        <div
          onClick={() => navigate('/demande-destinataire-light')}
          style={{
        ...
        <div style={{ padding: '28px 20px 0', display: 'flex', flexDirection: 'column', gap: 16 }}>
          ...
          >
            <span style={{ fontFamily: '"Rethink Sans", sans-serif', fontSize: 42, fontWeight: 800, color: '#1A1A2E' }}>
              EUR {displayCents(cents)}<span className="dml-cursor" style={{ fontWeight: 200, color: '#4F46E5' }}>|</span>
            </span>
          </div>
        ...
        {showRecap && (
          <>
            ...
            >
              ...
              <div style={{ height: 1, backgroundColor: '#EBEBF2' }} />
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
                  ...
                  <div style={{
                    ...
                    border: '1px solid #DDDDE8', padding: '12px 14px',
                    minHeight: 48,
                  }}>
                  <span style={{
                    fontFamily: 'Inter', fontSize: 14,
                    color: note.trim() ? '#1A1A2E' : '#AAAABC',
                    lineHeight: 1.5, fontStyle: note.trim() ? 'italic' : 'normal',
                  }}>
              ...
              <button
                onClick={() => navigate('/demande-succes-light')}
                style={{
                  width: '100%', height: 56, borderRadius: 16, backgroundColor: '#4F46E5',
                  border: 'none', cursor: 'pointer',
                  fontFamily: '"Rethink Sans", sans-serif', fontSize: 16, fontWeight: 700, color: '#FFFFFF',
