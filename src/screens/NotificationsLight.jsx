  ...
  return (
    <div
      ...
      style={{
        ...
        backgroundColor: '#FFFFFF', borderRadius: 14, border: '0.5px solid #E5E5F0',
        padding: '14px 16px',
    ...
    >
      ...
      <div style={{ flex: 1, display: 'flex', flexDirection: 'column', gap: 4, minWidth: 0 }}>
        <span style={{ fontFamily: 'Inter', fontSize: 14, fontWeight: 600, color: '#0A0A0F' }}>{title}</span>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-end', gap: 8, width: 60, flexShrink: 0 }}>
        <span style={{ fontFamily: 'Inter', fontSize: 11, fontWeight: 400, color: '#737373' }}>{time}</span>
...
export default function NotificationsLight() {
  ...
  return (
    ...
    >
      ...
      <div style={{
        ...
        <span style={{ fontFamily: 'Rethink Sans', fontSize: 18, fontWeight: 700, color: '#0A0A0F' }}>
          Notifications
        </span>
        {activeTab === 'unread' ? (
        ...
        {activeTab === 'unread' ? (
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
            ...
            <NotifCard
              ...
              time="Maintenant"
              unread
              onClick={() => navigate('/notification-detail-light')}
            />
          </div>
        ) : (
          /* ── Lu content ── */
          <div style={{ display: 'flex', flexDirection: 'column', gap: 24 }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
              ...
              <NotifCard
                ...
                icon={<GraduationCapIcon color="#818CF8" size={30} />}
