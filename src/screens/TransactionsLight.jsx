    ...
    <div onClick={() => route && navigate(route)} style={{
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 14 }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 3 }}>
          <span style={{ fontFamily: 'Inter', fontSize: 14, fontWeight: 600, color: '#0A0A0F' }}>{name}</span>
...
const RECENT = [
  {
    ...
    amount: '- EUR 100', amountColor: '#0A0A0F', type: 'Abonnement',
    icon: <FigmaIcon />,
  },
  {
  ...
  },
  {
    ...
    amount: '- EUR 99.00', amountColor: '#0A0A0F', type: 'Souscription',
    icon: <MediumIcon />,
  },
]
...
const MARCH = [
  {
    ...
    amount: '- EUR 160.00', amountColor: '#0A0A0F', type: 'Transfert',
    icon: <PhotoAvatar src={avatarMarc} />, route: '/transaction-detail-light',
  },
  {
    id: 'dribbble', name: 'Dribbble Pro', date: '16 Mars, 20:00',
    amount: '- EUR 160.00', amountColor: '#0A0A0F', type: 'Souscription',
    icon: (
      <div style={{
  ...
  },
  {
    ...
    amount: '- EUR 90.00', amountColor: '#EF4444', type: 'Erreur transfert',
    icon: <PhotoAvatar src={avatarSmith} />,
  },
]

export default function TransactionsLight() {
  ...
  return (
    ...
    >
      ...
      <div style={{
        ...
        >
          <SlidersHorizontal size={18} color="#0A0A0F" strokeWidth={1.75} />
        </div>
      </div>
      ...
      <div style={{
        ...
        padding: '12px 20px', backgroundColor: '#F7F8FC',
      }}>
        <div style={{
          height: 50, borderRadius: 14, backgroundColor: '#F0F0F8',
          display: 'flex', alignItems: 'center', gap: 10,
          padding: '0 16px',
        }}>
          <Search size={18} color="#737373" strokeWidth={1.75} />
      ...
      {/* Scrollable Content */}
      <div style={{
        position: 'absolute', top: 196, left: 0, right: 0, bottom: 71,
        overflowY: 'auto', padding: '16px 20px 32px',
        display: 'flex', flexDirection: 'column', gap: 20,
      }}>

        <span style={{ fontFamily: 'Inter', fontSize: 12, fontWeight: 600, color: '#9898B8', letterSpacing: 0.5 }}>
          Recent
        </span>
      ...
      <FilterSheet open={filterOpen} onClose={() => setFilterOpen(false)} onApply={() => { setFilterOpen(false); navigate('/transactions-filtered-light') }} theme="light" />
    </motion.div>
  )
}
