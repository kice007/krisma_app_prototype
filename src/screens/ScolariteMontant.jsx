...
export default function ScolariteMontant() {
  ...
  return (
    ...
    >
      <style>{`
        ...
        .sm-cursor { animation: smBlink 1s step-end infinite; user-select:none; }
      `}</style>
      ...
      <div style={{
        ...
        <div style={{
          ...
          >
            ...
            <span className="sm-cursor" style={{ fontFamily: '"Rethink Sans", sans-serif', fontSize: 42, fontWeight: 200, color: '#FFFFFF' }}>|</span>
          </div>

          {/* Université card */}
          <div style={{
            width: '100%', display: 'flex', alignItems: 'center', gap: 12,
            border: '1px solid #161c2c', borderRadius: 14, padding: '14px 16px',
          }}>
            <div style={{
        ...
        {showRecap && (
          <>
            ...
            >
              ...
              {/* Divider */}
              <div style={{ height: 1, backgroundColor: '#1E1E2E', marginBottom: 4 }} />
              ...
              {ROWS.map(({ l, v, bold }, i) => (
                <div key={l} style={{
                  ...
                  padding: '10px 0',
                  borderTop: i > 0 ? '1px solid rgba(30,30,46,0.4)' : 'none',
                }}>
                  <span style={{ fontFamily: 'Inter', fontSize: 13, color: '#737373' }}>{l}</span>
                  <span style={{ fontFamily: 'Inter', fontSize: 13, fontWeight: bold ? 700 : 500, color: '#FFFFFF' }}>{v}</span>
                </div>
              ))}

              {/* CTA */}
              <button
                onClick={() => navigate('/scolarite-succes')}
                style={{
                  width: '100%', height: 56, borderRadius: 16, backgroundColor: '#4F46E5',
