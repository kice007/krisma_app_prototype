    ...
    >
      ...
      <div style={{
        ...
        <div style={{
          ...
          <Settings2 size={16} color="#FFFFFF" strokeWidth={1.5} />
        </div>
      </div>
      ...
      <div style={{
        ...
        <motion.div {...fadeUp(0)} style={{
          ...
          <span style={{ fontFamily: '"Rethink Sans", sans-serif', fontSize: 20, fontWeight: 700, color: '#FFFFFF' }}>
            Lamine Koné
          </span>
          <div style={{
          ...
          {SETTINGS_ROWS.map(({ Icon, label, sub, route }, i) => (
            <div
              ...
              style={{
                ...
                borderBottom: i < SETTINGS_ROWS.length - 1 ? '1px solid #161C2C' : 'none',
              }}
            >
      ...
      <ParentTabBar activeTab="Profil" theme="dark" />
    </motion.div>
  )
}
