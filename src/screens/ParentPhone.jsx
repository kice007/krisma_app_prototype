    ...
    >
      ...
      >
        ...
        <div className="flex items-center justify-between" style={{ marginBottom: 20 }}>
          <motion.button
            onClick={() => navigate('/parrainage-code')}
            whileTap={{ scale: 0.93 }}
            style={{
          ...
          <div style={{ position: 'relative' }}>
            ...
            >
              ...
              >
                ...
                <span style={{ fontFamily: 'Inter', fontSize: 14, fontWeight: 500, color: activeDialColor, transition: 'color 0.2s ease' }}>
                  {country.dial}
                </span>
                <ChevronDown size={14} strokeWidth={2.5} color={activeChevronColor}
