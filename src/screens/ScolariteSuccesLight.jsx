...
function SuccessRings() {
  return (
    ...
    >
      {/* Outer ring */}
      <motion.div
        animate={ringPulse.animate}
        transition={{ ...ringPulse.transition, delay: 0 }}
        style={{
...
export default function ScolariteSuccesLight() {
  ...
  return (
    ...
    >
      ...
      <div style={{
        ...
        >
          Le paiement de votre scolarité a{'\n'}bien été effectué
        </motion.span>
      </div>
