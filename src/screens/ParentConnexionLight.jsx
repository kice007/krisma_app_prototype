...
export default function ParentConnexionLight() {
  ...
  const handleKey = useCallback((key) => {
    ...
    setPin(next)
    if (next.length === 4) {
      setTimeout(() => navigate('/parent-dashboard-light'), 300)
    }
  }, [pin, error, navigate])
  ...
  return (
    ...
    >
      {/* Radial glow — same ellipse as dark, creates purple tint at top */}
      <div style={{
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 20, width: '100%' }}>
          ...
          <motion.span
            ...
            style={{ fontFamily: 'Inter', fontSize: 14, color: 'rgba(255,255,255,0.85)', textAlign: 'center' }}
          >
            +225 07 07 07 07&nbsp;&nbsp;·&nbsp;&nbsp;
            <span onClick={() => navigate(-1)} style={{ color: '#4F46E5', cursor: 'pointer' }}>
              Modifier
            </span>
          </motion.span>
        </div>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 20, alignItems: 'center', width: '100%' }}>
          <span style={{ fontFamily: 'Inter', fontSize: 13, color: '#555577', textAlign: 'center' }}>
              ...
              {row.map(key => {
                ...
                return (
                  <motion.button
                    ...
                    whileTap={!isEmpty ? { scale: 0.92, backgroundColor: '#E8E8F0' } : {}}
                    style={{
                  ...
                  >
                    {isDel ? (
                      ...
                      <span style={{
                        fontFamily: '"Rethink Sans", sans-serif',
                        fontSize: 24, fontWeight: 700, color: '#1A1A2E', userSelect: 'none',
                      }}>
                        {key}
                      </span>
                    ) : null}
