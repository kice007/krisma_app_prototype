...
export default function EnvoyerConfirmation() {
  ...
  return (
    ...
    >
      <style>{`.ec-note::placeholder { color: #555; }`}</style>
      <StatusBar />
      ...
      <div style={{
        ...
        <div onClick={() => navigate('/envoyer-montant')} style={{
      ...
      <div style={{
        ...
        <div style={row}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 3 }}>
              <span style={{ fontFamily: 'Inter', fontSize: 14, fontWeight: 600, color: '#FFFFFF' }}>{SENDER.name}</span>
        ...
        {/* Confirm */}
        <button
          onClick={() => navigate('/envoyer-succes')}
          style={{
