        ...
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 28 }}>
          ...
          <motion.div {...fadeUp(0.18)} style={{ display: 'flex', flexDirection: 'column', gap: 16, width: '100%' }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
              <span style={{ fontFamily: 'Inter', fontSize: 13, color: '#FFFFFF' }}>Email</span>
              <input
                type="email"
                value={email}
            ...
            {/* Password */}
            <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
              <span style={{ fontFamily: 'Inter', fontSize: 13, color: '#FFFFFF' }}>Mot de passe</span>
              <div style={{ position: 'relative' }}>
                <input
                  ...
                  placeholder="••••••••"
                  style={{ ...INPUT_DARK, paddingRight: 48 }}
                />
                <button
