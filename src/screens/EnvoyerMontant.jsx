...
export default function EnvoyerMontant() {
  ...
  return (
    ...
    >
      <style>{`
        ...
        .em-cursor { animation: emBlink 1s step-end infinite; user-select:none; }
        .em-note::placeholder { color: #737373; }
      `}</style>
      ...
      <div style={{
        ...
        <div onClick={() => navigate('/envoyer-destinataire')} style={{
        ...
        <div style={{ padding: '16px 20px 0' }}>
          ...
          >
            <span style={{ fontFamily: '"Rethink Sans", sans-serif', fontSize: 42, fontWeight: 800, color: '#FFFFFF' }}>
              EUR {displayCents(cents)}<span className="em-cursor" style={{ fontWeight: 200 }}>|</span>
            </span>
          </div>
        ...
        <AnimatePresence>
          {showPad && (
            ...
            >
              ...
              <button
                onClick={() => navigate('/envoyer-confirmation')}
                style={{
