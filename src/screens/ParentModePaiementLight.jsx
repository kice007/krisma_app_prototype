...
export default function ParentModePaiementLight() {
  ...
  return (
    ...
    >
      ...
      <div style={{
        ...
        <div onClick={() => navigate('/parent-envoyer-montant-light')} style={{
      ...
      <div style={{
        ...
        backgroundColor: '#FFFFFF', borderRadius: '28px 28px 0 0',
        display: 'flex', flexDirection: 'column', justifyContent: 'space-between',
        padding: '28px 20px 32px',
      }}>
        <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
          <p style={{ fontFamily: '"Rethink Sans", sans-serif', fontSize: 18, fontWeight: 700, color: '#1A1A2E', margin: 0 }}>
              ...
              return (
                <div
                  ...
                  style={{
                    ...
                    border: sel ? '2px solid #4F46E5' : '1px solid #DDDDE8',
                    backgroundColor: sel ? 'rgba(79,70,229,0.04)' : 'transparent',
                ...
                >
                  <div style={{ display: 'flex', alignItems: 'center', gap: 14 }}>
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', gap: 4 }}>
                      <span style={{ fontFamily: 'Inter, sans-serif', fontSize: 14, fontWeight: 600, color: '#0A0A0F' }}>{m.name}</span>
                      <span style={{ fontFamily: 'Inter, sans-serif', fontSize: 12, color: '#9494B8' }}>{m.sub}</span>
                    </div>
                  </div>
                  {/* Radio */}
                  <div style={{
                    ...
                    border: sel ? 'none' : '1.5px solid #C8C8DC',
        ...
        {/* CTA */}
        <button
          onClick={() => navigate('/parent-envoyer-succes-light', {
