  ...
  return (
    <div
      ...
      style={{
        ...
        borderRadius: 14,
        backgroundColor: unread ? '#FFFFFF' : '#FFFFFF',
    ...
    >
      ...
      <div style={{ flex: 1, display: 'flex', flexDirection: 'column', gap: 3, minWidth: 0 }}>
        <span style={{ fontFamily: '"Rethink Sans", sans-serif', fontSize: 14, fontWeight: unread ? 700 : 600, color: '#1A1A2E' }}>
          {title}
        </span>
...
export default function ParentNotificationsLight() {
  ...
  return (
    ...
    >
      ...
      <div style={{
        ...
        {/* Tab switcher */}
        <div style={{
          display: 'flex', gap: 4, backgroundColor: '#EAEAF2',
          ...
          >
            <span style={{ fontFamily: 'Inter', fontSize: 13, fontWeight: 600, color: activeTab === 'unread' ? '#FFFFFF' : '#9999AA' }}>
              Non lu
            </span>
            <div style={{
              width: 18, height: 18, borderRadius: 9,
              backgroundColor: activeTab === 'unread' ? '#FFFFFF' : '#DDDDE8',
              display: 'flex', alignItems: 'center', justifyContent: 'center',
            }}>
              <span style={{ fontFamily: 'Inter', fontSize: 10, fontWeight: 700, color: activeTab === 'unread' ? '#4F46E5' : '#9999AA' }}>
          ...
          >
            <span style={{ fontFamily: 'Inter', fontSize: 13, fontWeight: 600, color: activeTab === 'read' ? '#FFFFFF' : '#9999AA' }}>
              Lu
            </span>
          </button>
        </div>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 24 }}>
            <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
              ...
              <NotifCard
                ...
                time="10:24"
                unread
                onClick={() => navigate('/parent-notification-detail-light')}
              />
            </div>
            <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
