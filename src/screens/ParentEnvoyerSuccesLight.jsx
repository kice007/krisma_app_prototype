...
export default function ParentEnvoyerSuccesLight() {
  ...
  return (
    ...
    >
      <style>{`
        @keyframes succPulseL {
          0%, 100% { transform: scale(1); opacity: 1; }
          50% { transform: scale(1.09); opacity: 0.65; }
        }
        .succ-pulse-l { animation: succPulseL 2.4s ease-in-out infinite; }
      `}</style>
      ...
      <div style={{
        ...
        <div className="succ-pulse-l" style={{ position: 'relative', width: 200, height: 200, flexShrink: 0 }}>
          {/* Outer ring */}
          <div style={{
        ...
        <p style={{
          ...
          color: '#141830', margin: 0, textAlign: 'center',
        }}>
        ...
        <div style={{
          ...
          padding: '12px 18px', border: '1px solid #DDDDE8',
          width: 295,
        }}>
      ...
      <div style={{
        ...
        <button style={{
          ...
          backgroundColor: '#F4F4F8', border: '1px solid #DDDDE8', cursor: 'pointer',
          fontFamily: 'Inter, sans-serif', fontSize: 14, fontWeight: 500, color: '#737373',
        }}>
          <Download size={16} color="#737373" strokeWidth={2} />
